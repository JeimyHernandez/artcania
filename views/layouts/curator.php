...
<title>Panel Curador – Artcania</title>
...
<div class="d-flex">
  <nav class="sidebar-magic d-flex flex-column flex-shrink-0">
    ...
    <span class="badge mb-3 px-2 py-1 mx-1" style="background:rgba(166,189,255,.1);color:var(--lavender);border:1px solid rgba(166,189,255,.2);font-size:.68rem;font-family:'Cinzel',serif;width:fit-content">
      Curador ✦
    </span>
    <ul class="nav flex-column gap-1 flex-grow-1">
      <li><a href="<?= url('curador/dashboard') ?>" class="nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a></li>
      <li><a href="<?= url('curador/obras-pendientes') ?>" class="nav-link"><i class="fa fa-clock me-2"></i>Obras Pendientes</a></li>
      <li><a href="<?= url('curador/historial') ?>" class="nav-link"><i class="fa fa-history me-2"></i>Historial</a></li>
      <li><a href="<?= url('curador/exposiciones') ?>" class="nav-link"><i class="fa fa-building me-2"></i>Exposiciones</a></li>
      <li><a href="<?= url('curador/destacados') ?>" class="nav-link"><i class="fa fa-star me-2"></i>Seleccionar Destacados</a></li>
      <li><a href="<?= url('curador/comentarios') ?>" class="nav-link"><i class="fa fa-comments me-2"></i>Moderar Comentarios</a></li>
      <li><a href="<?= url('curador/reportes') ?>" class="nav-link"><i class="fa fa-flag me-2"></i>Reportes</a></li>
      <li><a href="<?= url('curador/metricas') ?>" class="nav-link"><i class="fa fa-chart-bar me-2"></i>Métricas</a></li>
      <li><hr class="divider-magic my-2"></li>
      <li><a href="<?= url('galeria') ?>" class="nav-link"><i class="fa fa-compass me-2"></i>Ver Galería</a></li>
    </ul>
      ...
      <div class="d-flex align-items-center gap-2 px-2 mb-2">
        ...
        <?php else: ?>
          <div style="width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,var(--purple),var(--teal));
            ...
            <?= mb_strtoupper(mb_substr($user['nombre']??'C',0,1)) ?>
          </div>
        <?php endif; ?>
