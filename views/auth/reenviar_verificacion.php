...
<div class="auth-shell anim-fade-up">
  <div class="text-center mb-3">
    ...
    <h1 class="auth-title" style="font-size:1.5rem">VERIFICACIÓN</h1>
    <div class="auth-divider"><span>✦</span><span>✧</span><span>✦</span></div>
    <p class="auth-subtitle">Reenviaremos tu correo<br>de verificación encantado</p>
  </div>
  ...
  <form method="POST" action="<?= url('reenviar-verificacion') ?>" novalidate>
    ...
    <button type="submit" class="btn btn-magic w-100 py-3">
      <i class="fa fa-wand-magic-sparkles me-2"></i>Reenviar verificación
    </button>
  </form>

  <p class="text-center mt-3 mb-0" style="font-size:.92rem">
    <a href="<?= url('login') ?>" style="color:var(--magenta);font-weight:600">
